...
class Menu extends Phaser.Scene {
    ...
    create(data) {
        ...
        let playButton = new Button(this, width - 300, (height / 2) - 52 - 120, "Play", () => {
            this.scene.start("InstructionsSplash")
        }, true).setHighlighted(true)
        ...
        let harborButton = new Button(this, width - 300, (height / 2) - 52, "Harbor", () => {
            this.scene.start("HarborScene")
        }, this.playerWonGame)

        let forgeButton = new Button(this, width - 300, (height / 2) - 52 + 120, "Forge", () => {
