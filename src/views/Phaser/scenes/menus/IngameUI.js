...
class InGameUI extends Phaser.Scene {
    ...
    create() {
        ...
        this.playerHPShadow = this.add.text(
            22, 
            22, 
            "Health", 
            {
        ...
        this.bossHPShadow = this.add.text(
            this.width-18, 
            22, 
            "Health",
            { 
        ...
        events.on('boss-hit', (hp) => {
            ...
            for(let i = 0; i < diff; ++i) {
                ...
                if(hp >= 0)
                    this.bossHearts[hp+i].setFrame(1)
            }
            if(hp <= 5) {
         ...
         */
        events.on('switch-attack', (attack) => {
    ...
    drawHotbar() {
        ...
        let j = 0;
        for(let i = 0; i < 5; i++) {
            this.hotbarSlots[i] = this.add.sprite(this.width/2+(i*48)-(48*2+4), this.height, 'hotbar-sprite', j)
