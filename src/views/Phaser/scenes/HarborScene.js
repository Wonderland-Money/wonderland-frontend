...
class HarborScene extends Phaser.Scene
{
    ...
    addHarborKeeper() {
        this.harborKeeper = this.physics.add.sprite(
            this.harborKeeperSpawn.x,
            this.harborKeeperSpawn.y,
            'harbor-keeper'
        ).setOrigin(0.5, 1)
    ...
    addFire() {
        this.fire = this.physics.add.sprite(
            this.harborKeeperSpawn.x - 50,
            this.harborKeeperSpawn.y,
            'fire'
        ).setOrigin(0.5, 1)
    ...
    addMap() {
        ...
        const backgroundSprite = this.add.sprite(this.map.widthInPixels / 2, this.map.heightInPixels / 2, 'harbor-bg-anim').setOrigin(0.5, 0.5).setScrollFactor(0.9)
