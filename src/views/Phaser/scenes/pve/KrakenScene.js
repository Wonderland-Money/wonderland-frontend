...
import Boss from "../../entities/pve/kraken/Boss";

import HeroAttackGroup from "../../entities/pve/HeroAttackGroup";
import ProtectionOrbGroup from "../../entities/pve/kraken/ProtectionOrbGroup";
import CrystalGroup from "../../entities/pve/kraken/CrystalGroup";
import TentacleGroup from "../../entities/pve/kraken/TentacleGroup";
import EnergySphereGroup from "../../entities/pve/kraken/EnergySphereGroup";
...
class KrakenScene extends Phaser.Scene {
    ...
    loadEventHandlers() {
        ...
        events.on("player-died", () => {
            ...
            this.scene.bringToTop("DeathScreen");
            this.time.addEvent({
                delay: 2000,
                callback: () => {
                    deathLaughter.play();
    ...
    addHero() {
        this.hero = new HeroLegacy(this, this.spawnPos.x, this.spawnPos.y, true);
    ...
    bossKilled() {
        ...
        this.physics.add.overlap(this.hero, trident, (hero, trident) => {
            ...
            this.time.delayedCall(5000, () => {
                ...
                this.scene.bringToTop("PlayerWinScene");
            });
        });
