...
function Background() {
    ...
    return <div className="landing-background" style={{ position: "absolute", top: 0, left: 0 }} dangerouslySetInnerHTML={{ __html: bgWebGL }}></div>;
}

export default Background;

const bgWebGL = `<script id="vertexShader" type="x-shader/x-vertex">
