                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://www.traderjoexyz.com/#/trade?inputCurrency=&outputCurrency=${BLOCK_ADDRESS}`} target="_blank">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("BLOCKS", BLOCK_ADDRESS)}>
                                        <p>BLOCKS</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("zBLOCKS", MEMO_ADDRESS)}>
                                        <p>zBLOCKS</p>
                                    </div>
                                </div>
                            )}
